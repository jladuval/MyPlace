...
namespace Base.DDD.Domain.SharedKernel
{
    [DomainValueObject]
    public struct Money
    {
        ...
        {
            return _value == other._value && string.Equals(_currencyCode, other._currencyCode);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (_value.GetHashCode()*397) ^ (_currencyCode != null ? _currencyCode.GetHashCode() : 0);
            }
        }
